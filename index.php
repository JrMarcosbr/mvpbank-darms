  ...
  <nav class="navbar fixed-top ">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        <img  src="img/LOGO MJ BANK WHITE.png" alt="Logo" width="60" class="fadeIn second d-inline-block align-text-top">
      </a>
    </div>
  </nav>
  <div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <form method="post" action="cliente/verificar_login.php">
        ...
        <input type="password" id="password" class="fadeIn third" name="user_pass" placeholder="Senha">
        <input type="submit" class="fadeIn fourth mt-3" value="Entrar">
      </form>

      <div id="formFooter">
        <a class="underlineHover nav-link" href="form.php">Ainda não tem conta?</a>
        <a class="underlineHover nav-link" href="cliente/view/recuperar_senha.php">Esqueceu a senha?</a>
      </div>
